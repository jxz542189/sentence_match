from ESIM_model.esim_model import ESIM
import os
...
def feed_data(model, premise, premise_mask, hypothesis,
              hypothesis_mask, premise_pos, hypothesis_pos,
...
def evaluate(sess, model, premise, premise_mask, hypothesis,
              hypothesis_mask, premise_pos, hypothesis_pos,
              premise_char, hypothesis_char,
              premise_exact_match, hypothesis_exact_match,
              y):
    ...
    for i in range(batchNums):
        ...
        feed_dict = feed_data(model, batch_premises_np_train, batch_premises_mask_train, batch_hypothesis_np_train,
                              batch_hypothesis_mask_train, batch_premise_pos_train, batch_hypothesis_pos_train,
                              batch_premise_char_train, batch_hypothesis_char_train,
                              batch_premise_exact_match_train, batch_hypothesis_exact_match_train,
                              batch_labels_train, 1.0)
        _, batch_loss, batch_acc = sess.run([model.train, model.total_loss, model.acc], feed_dict=feed_dict)
