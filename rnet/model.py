...
from rnet.data_load import get_batch, get_dev
from rnet.layers import *
from rnet.GRU import gated_attention_Wrapper, GRUCell, SRUCell
from rnet.evaluate import *
import pickle
from rnet.process import *
from rnet.demo import Demo
...
class Model(object):
    ...
    def pointer_network(self):
        ...
        self.points_logits = pointer_net(self.final_bidirectional_outputs, self.passage_w_len,
                                         self.question_encoding, self.question_w_len, cell,
                                         params, scope = "pointer_network")
