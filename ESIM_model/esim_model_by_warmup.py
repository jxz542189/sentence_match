...
class ESIM(object):
    def __init__(self, seq_length, n_vocab, embedding_size,
                 ...
                 l2, clip_value, num_train_steps, num_warmup_steps):
        # model init
    ...
    def _training_op(self):
        with tf.name_scope('training'):
            train_op = optimization.create_optimizer(self.loss, self.learning_rate, self.num_train_steps, self.num_warmup_steps, self.clip_value)
            return train_op
