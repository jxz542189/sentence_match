from ESIM_model.esim_model_by_clr import ESIM
import os
from datetime import datetime
from ESIM_model import Config
from ESIM_model.Utils import *
from utils.data_util import *
from utils.clr import cyclical_learning_rate
...
def feed_data(model, premise, premise_mask, hypothesis,
              hypothesis_mask, y_batch, dropout_keep_prob, learning_lr):
    feed_dict = {
        ...
        model.learning_rate: learning_lr
    }
    return feed_dict


def evaluate(sess, model, premise, premise_mask, hypothesis, hypothesis_mask, y, learning_lr):
    ...
    for i in range(batchNums):
        ...
        feed_dict = feed_data(model, batch_premises_np_train, batch_premises_mask_train, batch_hypothesis_np_train,
                              ...
                              arg.dropout_keep_prob, learning_lr)
...
def train(model):
    ...
    isEarlyStop = False
    cycle_epochs = arg.cycle_epochs
    batch_step = -1
    cycle_mode = arg.cycle_mode
    ...
    for epoch in range(arg.num_epochs):
        ...
        step_size = batchNums * cycle_epochs
        ...
        for i in range(batchNums):
            batch_step += 1
            learning_lr = cyclical_learning_rate(batch_step=batch_step,
                                                 step_size=step_size,
                                                 mode=cycle_mode)
