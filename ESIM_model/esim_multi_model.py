...
class ESIM(object):
    def __init__(self, sess, seq_length, n_vocab, embedding_size,
    ...
    def predict(self, premise, hypothesis, premise_mask, hypothesis_mask, dropout_keep_prob=1.0):
        feed_dict = {self.premise: premise, self.hypothesis: hypothesis,
                     self.premise_mask: premise_mask, self.hypothesis_mask: hypothesis_mask,
